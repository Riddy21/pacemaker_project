    ...
    def serial_out(self, valid_parameters, parameters_dict, operating_mode):
        ...
        if(self.serialPort.is_open):
            ...
            if('vrp' in valid_parameters[operating_mode]):
                ...
                print(np.uint16(parameters_dict['vrp']),end="")
            else:
                self.serialPort.write(np.uint16(0))
                print(np.uint16(0),end="")
            ...
            if('ventricular_amplitude' in valid_parameters[operating_mode]):
                ...
                print(np.double(parameters_dict['ventricular_amplitude']),end="")
            else:
                self.serialPort.write(np.double(0))
                print(np.double(0),end="")
            ...
            if('ventricular_pw' in valid_parameters[operating_mode]):
                ...
                print(np.uint16(parameters_dict['ventricular_pw']),end="")
            else:
                self.serialPort.write(np.uint16(0))
                print(np.uint16(0),end="")
            ...
            if('fixed_av_delay' in valid_parameters[operating_mode]):
                ...
                print(np.uint16(parameters_dict['fixed_av_delay']),end="")
            else:
                self.serialPort.write(np.uint16(0))
                print(np.uint16(0),end="")
            ...
            if('reaction_time' in valid_parameters[operating_mode]):
                ...
                print(np.double(parameters_dict['reaction_time']),end="")
            else:
                self.serialPort.write(np.double(0))
                print(np.double(0),end="")
            ...
            if('recovery_time' in valid_parameters[operating_mode]):
                ...
                print(np.double(parameters_dict['recovery_time']),end="")
            else:
                self.serialPort.write(np.double(0))
                print(np.double(0),end="")
            ...
            if('lrl' in valid_parameters[operating_mode]):
                ...
                print(np.uint16(parameters_dict['lrl']),end="")
            else:
                self.serialPort.write(np.uint16(0))
                print(np.uint16(0))
